...
def test_specread():
    ...
    assert spec1._spectrum.shape == (1, 801)
    assert spec1._wavelength.shape == (801,)
    assert_array_equal(spec1._spectrum, spec2._spectrum)
    assert_array_equal(spec1._wavelength, spec2._wavelength)
